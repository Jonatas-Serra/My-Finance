...
export default function Receivables() {
  ...
  const { receivables, loading, handleDeleteAccount, getAccounts, PayAccount, UnpayAccount } = useAccounts()
...
const handleUnderPayAccount = async (id: string) => {
  try {
    ...
    addToast({
      ...
      description: 'Ocorreu um erro ao tentar desfazer o recebimento da conta'
    });
  }
}
    ...
    <>
      ...
      >
        <ContentModalPaid>
          ...
          <p>Tem certeza que deseja desfazer o recebimento da conta <strong>{selectedAccount.description}</strong> ?</p>
          <div>
            <button
              onClick={() => {
